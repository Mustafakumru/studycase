...
mean_quality, std_quality = determine_thresholds(quality_scores)

# Eşik değerlerini belirleme
min_quality_score = min(quality_scores)
max_quality_score = max(quality_scores)
median_quality_score = np.median(quality_scores)
low_quality_threshold = min_quality_score + (median_quality_score - min_quality_score) / 2
high_quality_threshold = median_quality_score + (max_quality_score - median_quality_score) / 2
